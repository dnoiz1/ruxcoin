...
This document provides guidelines for internationalization of the Ruxcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ruxcoin_en.ts` remains unchanged.
