Ruxcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/ruxcoin/files/Ruxcoin/ruxcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Ruxcoin
...
New/changed settings (command-line or ruxcoin.conf file)
--------------------------------------------------------
