Ruxcoin Core version 0.10.4 is now available from:

  <https://ruxcoin.org/bin/ruxcoin-core-0.10.4/>
...
- #6953 `43c2789` Split ruxcoin-tx into its own package
- #6953 `dfe0d4d` Include ruxcoin-tx binary on Debian/Ubuntu
