Ruxcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/ruxcoin/files/Ruxcoin/ruxcoin-0.5.4/
...
http://gitorious.org/ruxcoin/ruxcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Ruxcoin-Qt notifications under Growl 1.3.
Increase required age of Ruxcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxRuxcoin properly when installing Ruxcoin-Qt over it. (Windows)
