Ruxcoin Core version 0.9.2.1 is now available from:

  https://ruxcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 RUX to 0.01 RUX
...
- Fix "Start ruxcoin on system login"
