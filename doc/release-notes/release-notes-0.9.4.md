Ruxcoin Core version 0.9.4 is now available from:

  https://ruxcoin.org/bin/0.9.4/
...
this update is incompatible with the Ruxcoin system and could lead to consensus
forks.

Ruxcoin Core released binaries from https://ruxcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~ruxcoin/+archive/ubuntu/ruxcoin
- A third-party or self-compiled Ruxcoin Core

upgrade to Ruxcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
