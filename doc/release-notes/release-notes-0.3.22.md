Download URL: https://sourceforge.net/projects/ruxcoin/files/Ruxcoin/ruxcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 RUX fee schedule (users still pay 0.01 RUX per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #ruxcoin00 - #ruxcoin99
