...
unlocked to sign the Ruxcoin-Qt.app bundle.
...
allowing somebody to distribute a Ruxcoin-Qt.app or ruxcoin-qt-setup.exe with a valid
...
that the ruxcoin-qt.exe file inside the installer had not been tampered with.
