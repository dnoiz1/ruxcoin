 ...
 */
#ifndef RUXCOIN_UTIL_H
#define RUXCOIN_UTIL_H
...
extern const char * const RUXCOIN_CONF_FILENAME;
extern const char * const RUXCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("ruxcoin-%s", name);
