...
#define BOOST_TEST_MODULE Ruxcoin Test Suite

#include "test_ruxcoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_ruxcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
