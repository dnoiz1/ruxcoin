...
#ifndef RUXCOIN_TEST_SCRIPTNUM10_H
#define RUXCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Ruxcoin Core 0.10.0, for cross-comparison.
 */
public:
