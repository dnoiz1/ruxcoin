...
#ifndef RUXCOIN_QT_RUXCOINUNITS_H
#define RUXCOIN_QT_RUXCOINUNITS_H
...
/** Ruxcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class RuxcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit RuxcoinUnits(QObject *parent);

    /** Ruxcoin units.
      @note Source: https://en.ruxcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        RUX,
...
typedef RuxcoinUnits::Unit RuxcoinUnit;

#endif // RUXCOIN_QT_RUXCOINUNITS_H
