...
#if defined(NDEBUG)
# error "Ruxcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Ruxcoin Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s RUX additional fees, %d delta bytes\n",
