// Copyright (c) 2013-2015 The Ruxcoin Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CRuxcoinAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CRuxcoinAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CRuxcoinAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CRuxcoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CRuxcoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CRuxcoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
