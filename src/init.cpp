 ...
 * between ruxcoind, and ruxcoin-qt and non-server tools.
*/
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-conf=<file>", strprintf(_("Specify configuration file (default: %s)"), RUXCOIN_CONF_FILENAME));
    if (mode == HMM_RUXCOIND)
    {
#ifndef WIN32
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), RUXCOIN_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/ruxcoin/ruxcoin>";
    const std::string URL_WEBSITE = "<https://ruxcoincore.org>";
...
/** Sanity checks
 *  Ensure that Ruxcoin is running in a usable environment with all
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single Ruxcoin process is using the data directory.
