...
class RawTransactionsTest(RuxcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid ruxcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid ruxcoin address" in e.error['message'])
