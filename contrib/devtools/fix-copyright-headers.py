...
// Copyright (c) 2009-2012 The Ruxcoin Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Ruxcoin/$1-%s The Ruxcoin/' %s"
REGEX_CURRENT= re.compile("%s The Ruxcoin" % year)
